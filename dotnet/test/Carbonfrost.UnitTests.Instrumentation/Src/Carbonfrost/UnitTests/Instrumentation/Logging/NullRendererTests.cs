...
namespace Carbonfrost.UnitTests.Instrumentation.Logging {
    ...
    public class NullRendererTests {
        ...
        public void Class_should_be_a_provider_type() {
            Assert.Contains(typeof(NullRenderer), App.GetProviderTypes(typeof(Renderer)));
            Assert.Equal(typeof(NullRenderer), App.GetProviderType(typeof(Renderer), "null"));
        }
    }
}
